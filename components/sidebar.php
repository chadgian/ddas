<aside class="sidebar">
  ...
  <nav class="sb-nav">
    ...
    <div class="nav-item active" id="n-dashboard" onclick="nav('dashboard')">
      <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg>
      Dashboard <span class="nav-bdg nb-b" id="nb-dashboard">3</span>
    </div>
    <div class="nav-item" id="n-upload" onclick="nav('upload')">
    ...
    <div class="nav-item" id="n-search" onclick="nav('search')">
      <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.35-4.35"/></svg>
      Search & Retrieve
    </div>
    <div class="nav-item" id="n-requirements" onclick="nav('requirements')">
      ...
      Requirements <span class="nav-bdg nb-r" id="nb-req" style="display:none">0</span>
    </div>
    <div class="nav-grp">Management</div>
    <div class="nav-item" id="n-ocr" onclick="nav('ocr')">
      ...
      OCR Queue <span class="nav-bdg nb-y" id="nb-ocr">5</span>
    </div>
    <div class="nav-item" id="n-archive" onclick="nav('archive')">
      <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="21 8 21 21 3 21 3 8"/><rect x="1" y="3" width="22" height="5" rx="1"/><line x1="10" y1="12" x2="14" y2="12"/></svg>
      Archive <span class="nav-bdg nb-g" id="nb-archive">12</span>
    </div>
    ...
    <div class="nav-item" id="n-logs" onclick="nav('logs')">
      <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="12" x2="15" y2="12"/><line x1="9" y1="16" x2="12" y2="16"/></svg>
      Activity Logs
    </div>
    <div class="nav-grp">System</div>
    <div class="nav-item" id="n-settings" onclick="nav('settings')">
