<div id="loginWrap">
  <div class="login-box">
    <div class="login-logo">
      <div class="gov-badge">🏛 CSC RO VI - PSED</div>
    ...
    <div class="fld"><label>Username</label><input id="lusr" value="admin.dela_cruz" placeholder="Username"></div>
    <div class="fld"><label>Password</label><input id="lpwd" type="password" value="password123" placeholder="Password"></div>
